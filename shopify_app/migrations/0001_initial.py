...
>>>>>>> 191916d3d05eac0019cb7a85b686f811268b66c2
...
=======
                ...
                ('temp_token', models.CharField(max_length=255, unique=True)),
                ('status', models.CharField(choices=[('active', 'Active'), ('expired', 'Expired')], default='active', max_length=10)),
                ('charge_id', models.CharField(max_length=255, primary_key=True, serialize=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('expiration_time', models.DateTimeField()),
...
>>>>>>> 191916d3d05eac0019cb7a85b686f811268b66c2
                ...
                ('algo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='shopify_app.clientalgo')),
<<<<<<< HEAD
            ],
            options={
